...
CSRF_TRUSTED_ORIGINS = ["https://bella-napoli-production.up.railway.app", "https://*.up.railway.app"]
...
SITE_NAME = config('SITE_NAME', default='Bella Napoli')
SITE_URL = config('SITE_URL', default='https://bella-napoli-production.up.railway.app')
